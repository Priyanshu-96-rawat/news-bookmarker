...
import { HiOutlineEnvelope, HiOutlineLockClosed, HiOutlineEye, HiOutlineEyeSlash, HiOutlineNewspaper, HiOutlineUser } from "react-icons/hi2";
            ...
            <div className="w-full max-w-sm animate-slide-up">
                <div className="bg-white dark:bg-[#24272b] rounded-lg p-8 shadow-sm border border-slate-200 dark:border-slate-800">
                    ...
                    <div className="mb-8 flex flex-col items-center">
                        ...
                        <h1 className="text-xl font-bold text-slate-900 dark:text-white mt-2">Create account</h1>
                        <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">Join NewsMarker to save articles</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="space-y-1.5">
                            <label htmlFor="name" className="text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
                                Full Name
                            </label>
                        ...
                        <div className="space-y-1.5">
                            <label htmlFor="confirm-password" className="text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider">
                                Confirm Password
                            </label>
                            <div className="relative">
                                <HiOutlineLockClosed className="pointer-events-none absolute left-3 top-1/2 h-5 w-5 -translate-y-1/2 text-slate-400" />
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-[13px] text-slate-500 dark:text-slate-400">
                            ...
                            <Link href="/login" className="font-semibold text-[#2bb24c] hover:text-[#269d43] transition-colors">
                                Sign In
                            </Link>
                        </p>
                    </div>
